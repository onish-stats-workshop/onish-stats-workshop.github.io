...
* The relationship may not necessarly be interesting to the Fisher and Anderson's original goals, but...
* is this a good dataset for linear regression?
* Does the fit accurately describe the relationship betwee the variables, given the separation in groups?
